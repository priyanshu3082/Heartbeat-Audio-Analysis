    ...
    return (
        <div className="container mx-auto px-4 py-16">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {dataset.stats.map((stat, statIndex) => (
                                ...
                                >
                                    <div className="text-3xl font-bold mb-2 text-blue-700 dark:text-blue-300">
                                        {stat.value}
                                    </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-10 border border-blue-100 dark:border-slate-700 shadow-sm animate-fadeIn">
                <h2 className="text-4xl font-bold text-center mb-8 text-slate-900 dark:text-slate-50">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {keyFeatures.map((feature, index) => (
                        ...
                        >
                            <div className="text-blue-700 dark:text-blue-400 mb-2 flex justify-center"><CheckCircle2 size={20} /></div>
