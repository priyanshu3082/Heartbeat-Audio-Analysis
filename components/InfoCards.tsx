...
const cards = [
    {
        ...
        description:
            'Heart disease remains the leading cause of global mortality. Our system helps monitor and identify patterns that require clinical attention, aiming to reduce these statistics through accessible technology.',
    },
    {
        ...
        description:
            'Our mission is to democratize cardiac health monitoring. By making reliable heartbeat classification available to everyone, we enable proactive healthcare and earlier interventions.',
    },
];
                            ...
                            >
                                <div className="flex items-start justify-between mb-6">
                                    <div className="flex items-center space-x-4">
                                        <div
                                            className={`p-4 rounded-2xl ${card.color} dark:bg-slate-800/80 ${card.darkTone} group-hover:scale-110 transition-transform duration-300`}
                                        >
                                            <Icon size={32} />
                                        </div>
                                        <div>
                                ...
                                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-6 border border-slate-100 dark:border-slate-600">
                                    <p className="text-slate-600 dark:text-slate-300 leading-relaxed italic">&quot;{card.description}&quot;</p>
                                </div>
